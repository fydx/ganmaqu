...
public final class Connect
{
	 ...
	 */
	public String GetFullRoute(String type, String pos_x,String pos_y, String json, String id) throws JSONException
	{
...
//			params.add(new BasicNameValuePair("city", city));
	 ...
	 * @return 路线 json字符串
	 */
	public String GetUpper(String type, String pos_x,String pos_y, String cost, String json, String id)
	{
		DefaultHttpClient httpclient = new DefaultHttpClient();
		try
		{
...
//			params.add(new BasicNameValuePair("city", city));
	 ...
	 * @return
	 */
	public String GetLower(String type, String pos_x,String pos_y, String cost, String json, String id)
	{
		DefaultHttpClient httpclient = new DefaultHttpClient();
		try
		{
	 ...
	 * @return
	 */
	public String GetDisRoute(double pos_x, double pos_y, double shop_x, double shop_y, int change, int cost, String id, String type)
	{
		DefaultHttpClient httpclient = new DefaultHttpClient();
		try
		{
			HttpHost target = new HttpHost(ipString, 8080, "http");
			String request = "/?command=changedis&id=" + id + "&pos_x=" + pos_x + "&pos_y=" + pos_y + "&shop_x=" + shop_x + "&shop_y=" + shop_y + "&dis=" + change + "&cost=" + cost + "&type=" + type;
			HttpGet req = new HttpGet(request);
			System.out.println("executing request to " + target);
			HttpResponse rsp = httpclient.execute(target, req);
			HttpEntity entity = rsp.getEntity();
